...
insert  into `dpapp_bookings`(`booking_id`,`booking_date_time`,`Booking_status`,`patient_id`,`schedule_id`,`user_id`) values (11,'2024-03-19','paid',5,6,6),(9,'2024-03-14','paid',5,6,6),(10,'2024-03-14','paid',2,6,1),(12,'2024-03-25','paid',6,6,9),(13,'2024-03-25','pending',2,7,1),(14,'2024-03-27','paid',2,6,1);
...
insert  into `dpapp_chat`(`id`,`message`,`date_time`,`from_id_id`,`to_id_id`) values (24,'hiii','2024-03-18 11:20:39.508000',21,22),(23,'haii doctor','2024-03-14 07:39:51.291358',22,21),(22,'haiii','2024-03-14 07:23:15.635719',22,21),(25,'hi doctor how are you doing','2024-03-25 14:45:08.902768',28,22),(26,'hiiii','2024-03-27 13:46:14.646972',1,22),(27,'hlooo','2024-03-27 13:48:28.887157',22,1);
...
insert  into `dpapp_lab`(`lab_id`,`lab_name`,`lab_phone`,`lab_email`,`login_id`) values (1,'labc','6666666666','lab@gmail.com',33);
...
insert  into `dpapp_labtest`(`labtest_id`,`test_date`,`test_name`,`test_description`,`test_amount`,`test_status`,`booking_id`,`lab_id`) values (1,'2024-03-25','shbbhc ','bxsbb','500','paid',10,1),(2,'2024-03-25','snb','sbbs','pending','Forwarded',10,1),(3,'2024-03-27','jjjj','hhhh','6667','paid',10,1);
...
insert  into `dpapp_login1`(`login_id`,`username`,`password`,`usertype`) values (1,'akhila','akhila','user'),(2,'admin','admin','admin'),(21,'anami','anami','user'),(25,'dddd','dddd','user'),(6,'ss','sss','doctor'),(7,'appu','apuu','user'),(10,'ph','ph','pharmacy'),(27,'hari','hari','doctor'),(13,'appu','apuu','user'),(14,'appu','apuu','user'),(16,'sree','sree123','user'),(17,'anu','anu','doctor'),(22,'samatha','sama','doctor'),(23,'arya','arya','user'),(24,'helen','helen','doctor'),(28,'joby123','joby123','user'),(29,'vis','Vis','user'),(30,'asha','Asha123456','user'),(31,'anju','Anju@gmai.com','user'),(32,'ridhu','Ridhu','user'),(33,'lab','lab','lab'),(34,'arun','arun','user'),(35,'siva','Siva','user'),(38,'appu','appu','pending'),(39,'sneha','sneha','pending'),(40,'chippy','Chippy','pending'),(41,'sumith','sumith','user'),(42,'akash','akash','user'),(43,'aushin','aushin','user');
...
insert  into `dpapp_payments`(`pay_id`,`amount`,`payment_date`,`payment_type`,`booking_id`) values (8,'400','2024-03-19','doctor',11),(7,'400','2024-03-14','doctor',10),(6,'400','2024-03-14','doctor',9),(9,'400','2024-03-25','doctor',12),(10,'1000','2024-03-25','subscription',13),(11,'500','2024-03-25','lab',1),(12,'500','2024-03-25','lab',1),(13,'400','2024-03-27','doctor',14),(14,'6667','2024-03-27','lab',3),(15,'1000','2024-03-27','subscription',15),(16,'1000','2024-03-27','subscription',18),(17,'1000','2024-03-27','subscription',19),(18,'1000','2024-03-27','subscription',21),(19,'1000','2024-03-27','subscription',22),(20,'499','2024-03-27','subscription',22),(21,'499','2024-03-27','subscription',22),(22,'499','2024-03-27','subscription',23),(23,'499','2024-03-27','subscription',23);
...
insert  into `dpapp_schedule`(`schedule_id`,`start_time`,`end_time`,`schedule_date`,`fee_amount`,`doctor_id`) values (6,'15:00','18:00','2024-03-16','400',8),(7,'23:23','00:24','2024-03-26','1000',11),(8,'14:42','15:45','2024-03-28','1000',11);

/*Table structure for table `dpapp_subscription` */

DROP TABLE IF EXISTS `dpapp_subscription`;

CREATE TABLE `dpapp_subscription` (
  `sub_id` int(11) NOT NULL AUTO_INCREMENT,
  `amount` varchar(225) NOT NULL,
  `from_date` varchar(225) NOT NULL,
  `to_date` varchar(225) NOT NULL,
  `sub_status` varchar(225) NOT NULL,
  `user_id` int(11) NOT NULL,
  PRIMARY KEY (`sub_id`),
  KEY `dpapp_subscription_user_id_00a22000` (`user_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

/*Data for the table `dpapp_subscription` */

insert  into `dpapp_subscription`(`sub_id`,`amount`,`from_date`,`to_date`,`sub_status`,`user_id`) values (1,'1000','2024-03-27','2024-06-25','subscribed',22),(3,'499','2024-03-27','2024-06-25','subscribed',23);
...
insert  into `dpapp_user`(`user_id`,`user_fname`,`user_lname`,`place`,`phone`,`email`,`login_id`) values (1,'akhila','kr','mkd','88888888888','Akhila@gmail.com',1),(2,'appu','m','mkd','6337333','appu@gmail.com',7),(3,'anu','dfvd','dgh','234567','zfbftnm@gmail.com',13),(4,'errr','bgnc','fvju','3456785789','nandi2@gmail.com',14),(5,'sree','priya','vaikom','9876543213','sree@gmail.com',16),(6,'Anamika','A','chottanikkara','9812097654','ana@gmail.com',21),(7,'Arya','ks','vaikom','8790654378','arya@gmail.com',23),(9,'joby','varghese','TVLA','9090309895','joby@gmail.com',28),(10,'vismaya','a','parappuram','7890567899','vis@gmail.com',29),(11,'Ashaaaa','kr','atpd','9944444999','as@gmail.com',30),(12,'Anjuu','K','mkd','8989767880','anju@gmail.com',31),(13,'ridhu','r','pkd','9999999999','ridhu@gmail.com',32),(14,'arun','kj','mkd','3456666666','athi@gmail.com',34),(15,'siva','s','kodungallur','7890567899','siva@gmail.com',35),(18,'appu','h','pkd','2345678978','appukuttan@gmail.com',38),(19,'sneha','s','mkd','7890567899','s@gmail.com',39),(20,'chippy','s','mkd','7890567899','c@gmail.com',40),(21,'sumith','s','mkd','7890567899','sumith@gmail.com',41),(22,'akash','m','pkd','9999999999','akash@gmail.com',42),(23,'aushin','j','pkd','9999999999','aushin@gmail.com',43);
